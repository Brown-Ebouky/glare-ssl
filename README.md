...
![Attention maps](figs/attention_maps.png)
...
![Coco object detection](figs/coco_results.png)

### Results of GLARE on linear probing on ImageNet

![linear probing](figs/linear_prob.png)

### Semantic Segmentation on additional benchmark datasets

![linear probing](figs/semantic_results.png)